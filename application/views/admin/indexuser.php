...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <a href="<?= base_url('admin/tambahuser') ?>" class="btn btn-primary mt-4">Tambah</a>
    <div class="card mt-4">
        ...
        <tbody>
          ...
          <?php foreach ($user as $u) : ?>
            <tr align = "center">
              ...
              <td><?= $u['password'] ?></td>
              <td>
              <a href="<?= base_url('admin/edituser/') ?><?= $u['id_user'] ?>" class="btn btn-warning">Edit</a>
              <a href="<?= base_url('admin/hapususer/') ?><?= $u['id_user'] ?>" class="btn btn-danger">Hapus</a>
            </td>
            </tr>
            <?php $i++; ?>
          <?php endforeach; ?>
