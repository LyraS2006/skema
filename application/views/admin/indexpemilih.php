...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <a href="<?= base_url('admin/tambahpemilih') ?>" class="btn btn-primary mt-4">Tambah</a>
    <div class="card mt-4">
      ...
      <table  class="table table-striped " >
        ...
        <tbody>
          <?php $i = 1; ?>
          <?php foreach ($pemilih as $pilih) : ?>
            <tr align = "center">
              <th scope="row"><?= $i; ?></th>
              <td><?= $pilih['username'] ?></td>
              <td><?= $pilih['nama'] ?></td>
              <td><?= $pilih['password'] ?></td>
              <td><?= $pilih['NISN'] ?></td>
              <td><?= $pilih['alamat'] ?></td>
              <td>
              <a href="<?= base_url('admin/editpemilih/') ?><?= $pilih['id_pemilih'] ?>" class="btn btn-warning">Edit</a>
              <a href="<?= base_url('admin/hapuspemilih/') ?><?= $pilih['id_pemilih'] ?>" class="btn btn-danger">Hapus</a>
            </td>
            </tr>
            <?php $i++; ?>
          <?php endforeach; ?>
